...
#define STRING_CONFIG_H_AUTHOR "jesus" // Original author or contributor.
...
//
#define LCD_FEEDBACK_FREQUENCY_DURATION_MS 200  // Ender Configs
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_PIN                PB1 // LED driving pin
